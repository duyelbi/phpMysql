...
<body>
    <p><img src="imgLab1/../imgLap1/MAMP-PRO-Logo.png" id="logo" alt="MAMP PRO Logo" width="250" height="49" /></p>
    ...
    <p class="text">
        ...
        Document root: <samp>C:/MAMP/htdocs</samp>
    </p>
    <p class="text" id="footnote_1"><small><sup>1</sup> Files: <samp>index.php</samp> and <samp>MAMP-PRO-Logo.png</samp></small></p>
    <hr />
    <p class="text">Diese Seite auf: <a href="/index.php?language=de" lang="de" xml:lang="de" hreflang="de">Deutsch</a></p>
